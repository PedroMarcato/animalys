...
public class GerarFichaCadastral implements Serializable{
	...
	public void gerar(Solicitacao solicitacao) {
		...
		try {  
            ...
            String caminho = FacesContext.getCurrentInstance().getExternalContext().getRealPath("/arquivos/relatorios/fichaCadastralAnimal.jrxml");
...
//            JasperReport jasperReport = JasperCompileManager.compileReport("C:\\animalys\\relatorios\\fichaCadastralAnimal.jrxml");  
//         
