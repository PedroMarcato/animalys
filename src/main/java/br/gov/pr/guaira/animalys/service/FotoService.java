...
public class FotoService {
    ...
    * @PostConstruct
    public void init() {
        ...
        if (this.caminhoFotosBase == null) {
            throw new RuntimeException("Não foi possível determinar o caminho físico para /resources/fotos");
        }
    ...
    * */
    ...
    public String obterUrlFoto(FotoAnimal fotoAnimal) {
        ...
        // Se você está salvando as fotos em um diretório que é servido diretamente pelo servidor web
        // (e.g., via um alias ou contexto virtual), você pode retornar a URL relativa a esse mapeamento.
        // Se as fotos estão dentro de webapp/resources/fotos, então o caminho relativo é suficiente.
        // Se as fotos estão fora do webapp, você precisará de um servlet para servi-las.
