...
public class DateUtils {
    ...
    public static Calendar lowDateTime(Calendar date) {
        
        toOnlyDate(date); //zera os parametros de hour,min,sec,milisec
        return date;
    }
    /**
    ...
    public static Calendar highDateTime(Calendar date) {
        
        toOnlyDate(date); //zera os parametros de hour,min,sec,milisec
        date.roll(Calendar.DATE, true); //vai para o dia seguinte
        date.roll(Calendar.MILLISECOND, false); //reduz 1 milisegundo
        return date;
    }
    /**
